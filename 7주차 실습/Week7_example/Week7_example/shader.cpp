...
void Shader::setOutWorldTransform(const glm::mat4& mat)
{
	outWorldLocation = glGetUniformLocation(program, "outWorldTransform");
	glUniformMatrix4fv(outWorldLocation, 1, GL_FALSE, glm::value_ptr(mat));
}
...
void Shader::setProjTransform(const glm::mat4 mat)
{
	projLocation = glGetUniformLocation(program, "projTransform");
	glUniformMatrix4fv(projLocation, 1, GL_FALSE, glm::value_ptr(mat));
}
